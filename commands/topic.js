exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
  ...
  let replies = ["What are the magic numbers on your parents credit card?", 
                 ...
                 "Grass who?", 
                 "Which bot is best? (HINT: It starts with Scrotum and ends with Totem)", 
                 "How is the Scrotum Totem so damn amazing?", 
                 "Who is the most attractive Green",
                 "If you had to choose one person to exile from Green, not due to personal opinion but solely because based on their crimes against humanity, who would it be?", 
                 "Is there anybody in the world who can challenge beet for the title of biggest weeb?", 
                 "Why did papa Heli leave us :(", 
